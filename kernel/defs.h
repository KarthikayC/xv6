...
void            raid_write(uint, uint64);
void            raid_read(uint, uint64);
...
void            kfree(void *);
void            kinit(void);
void            pin_page(uint64);
void            unpin_page(uint64);
...
void            swapinit(void);
int             write_to_swap(uint64);
void            read_from_swap(int, uint64);
void            register_frame(uint64, struct proc *, uint64);
